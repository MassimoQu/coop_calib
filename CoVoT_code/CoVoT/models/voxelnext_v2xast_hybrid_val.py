...
from opencood.models.sub_modules.astformer_val import AST
...
class VoxelNeXtV2XASTHybridVal(nn.Module):
    def __init__(self, args):
        super(VoxelNeXtV2XASTHybridVal, self).__init__()
        ...
        self.backbone_3d = VoxelResBackBone8xVoxelNeXt3D(4, args['backbone_3d'],
                                            args['grid_size'])
        # Vote2Fuse module
        self.vote2fusion = AST(args = args['fusion'])
    ...
    def backbone_fix(self):
        ...
        for param in self.vote2fusion.block_list.parameters():
            param.requires_grad = False
