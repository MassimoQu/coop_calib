...
import copy
import time
from ...pcdet_utils.roiaware_pool3d.roiaware_pool3d_utils import points_in_boxes_gpu
from .focal_sparse_conv.focal_sparse_utils import FocalLoss
...
class DynamicFocalPruningDownsample(spconv.SparseModule):
    ...
    def calulate_focal_loss(self, x, voxel_importance, batch_dict, voxel_stride):
        ...
        voxel_size = (self.point_cloud_range[3:][self.inv_idx] - self.point_cloud_range[:3][self.inv_idx])/spatial_shape
        voxels_3d = spatial_indices * voxel_size + self.point_cloud_range[:3][self.inv_idx]
        # print("voxels_3d:", voxels_3d)
        # print("voxel_stride:", voxel_stride, "point_cloud_range:", self.point_cloud_range, "voxel_size:", voxel_size)
        batch_size = x.batch_size
        mask_voxels = []
        box_of_pts_cls_targets = []
