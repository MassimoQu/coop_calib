...
from opencood.models.sub_modules.sst_ops import flat2window_v2, window2flat_v2, build_norm_layer
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, d_model, nhead, dropout, batch_first=False, layer_id=None, layer_cfg=dict()):
        ...
        if layer_cfg.get('cosine', False):
            from opencood.models.sub_modules.cosine_msa import CosineMultiheadAttention
        ...
        #     )
            ...
            # from opencood.models.sub_modules.flashmha import FlashMHA
            # self.self_attn = FlashMHA(d_model, nhead, attention_dropout=dropout)
    ...
    def forward(self, feat_2d, pos_dict, ind_dict, key_padding_dict):
        ...
        for name in feat_3d_dict:
            ...
            out_feat_3d, attn_map = self.self_attn(q, k, v, key_padding_mask=key_padding_mask)
...
class BasicShiftBlockV2(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
                 activation="gelu", batch_first=False, block_id=-100, layer_cfg=dict()):
        super().__init__()
