...
class SpVoxelPreprocessorGPU(BasePreprocessor):
    def __init__(self, preprocess_params, train):
        super(SpVoxelPreprocessorGPU, self).__init__(preprocess_params,
                                                  train)
        self.spconv = 1
        try:
            # spconv v1.x
    ...
    def preprocess(self, pcd):
        ...
        if self.spconv == 1:
            ...
            pcd = tv.from_numpy(pcd)
            voxel_output = self.voxel_generator.point_to_voxel(pcd)
