...
from opencood.data_utils.pre_processor.sp_voxel_preprocessor_gpu import SpVoxelPreprocessorGPU
...
__all__ = {
    ...
    'SpVoxelPreprocessorGPU': SpVoxelPreprocessorGPU
}
...
def build_preprocessor(preprocess_cfg, train):
    ...
    assert process_method_name in ['BasePreprocessor', 'VoxelPreprocessor',
                                   'BevPreprocessor', 'SpVoxelPreprocessor','SpVoxelPreprocessorGPU'], \
        error_message
